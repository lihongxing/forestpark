<? require(\Yii::getAlias("@app")."/views/layouts-/header-gw.php");?>
	...
	<div class="clearfix" style="margin-bottom:5em;">
		...
		<div class="input-group">
			...
			{if $_W['setting']['platform']['authstate']}<a style="margin-left:5px;" href="{$authurl}"><img src="https://open.weixin.qq.com/zh_CN/htmledition/res/assets/res-design-download/icon_button3_2.png" /></a>{/if}
		</div>
		<br>
