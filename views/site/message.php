...
<body>
<script type="text/javascript">$(function(){$('body').prepend('<div id="upgrade-component-tips" style="z-index: 999999;" class="upgrade-tips"><a href="./index.php?c=cloud&a=upgrade&">您使用的系统是简易版,请注册云服务更新到完整版！</a></div>');});</script><div class="gw-container">
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<a href="http://www.we7.cc">关于微擎</a>&nbsp;&nbsp;<a href="http://bbs.we7.cc">微擎论坛</a>&nbsp;&nbsp;<a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODAwMzEzOV8xNzEwOTZfNDAwMDgyODUwMl8yXw">联系客服</a>			</div>
		<div class="text-center">
			Powered by <a href="http://www.we7.cc"><b>微擎</b></a> v &copy; 2014-2015 <a href="http://www.we7.cc">www.we7.cc</a>			</div>
	</div>
</div>
