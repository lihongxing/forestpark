...
<div class="register">
    <div class="logo"><a href="./?refresh" {if !empty($_W['setting']['copyright']['flogo'])}style="background:url('{php
        echo tomedia($_W['setting']['copyright']['flogo']);}') no-repeat;"{/if}></a></div>
            ...
            <div class="panel-body">
                <form action="" method="post" role="form" id="form1">
                    ...
                    <div class="form-group">
                        ...
                        <input name="password" type="password" id="repassword" class="form-control"
                               placeholder="请再次输入密码">
                    </div>
                    <!--
                    {if $extendfields}
