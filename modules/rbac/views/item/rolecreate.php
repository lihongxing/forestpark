        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form class="form-horizontal" id="addrole" method="post"
                      action="<?= \yii\helpers\Url::toRoute('/rbac/role/create') ?>">
                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="inputEmail3">角色名称</label>
                            <div class="col-sm-10">
                                <input type="text" name="AuthItem[name]" placeholder="请输入角色名称" id="authitem-name"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea id="authitem-description" class="form-control" placeholder="请输入角色描述" rows="2"
                                          name="AuthItem[description]"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="inputPassword3">角色规则</label>
                            <div class="col-sm-10">
                                <input id="rule_name" class="form-control" placeholder="请输入角色规则" type="text"
                                       name="AuthItem[ruleName]" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="inputPassword3">角色数据</label>
                            <div class="col-sm-10">
                                <textarea rows="6" name="AuthItem[data]" placeholder="请输入角色数据" class="form-control"
                                          id="authitem-data"></textarea>
                            </div>
                        </div>
...
<script type="text/javascript">
    $().ready(function () {
        require(["validation"], function (validate) {
            $("#addrole").validate({
                rules: {
                    "AuthItem[name]": {
                        required: true,
