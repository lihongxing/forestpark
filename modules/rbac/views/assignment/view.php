        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="border-radius: 0px">未分配角色</div>
                    <input type="hidden" id="assign" name="assign" value="<?=\yii\helpers\Url::toRoute(['assign', 'id' => $model->id])?>">
                    <div id="new_fieldsrole" class="panel-body">
                    </div>
                    <div class="panel-heading" style="border-radius: 0px">未分配权限</div>
                    <input type="hidden" id="assign" name="assign" value="<?=\yii\helpers\Url::toRoute(['assign', 'id' => $model->id])?>">
                    <div id="new_fieldspermission" class="panel-body">
                    </div>
                </div>
            </div>
            <!--
            ...
            <div class="col-sm-6">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="border-radius: 0px">已分配角色</div>
                    <input type="hidden" id="remove" name="remove" value="<?=\yii\helpers\Url::toRoute(['remove', 'id' => $model->id])?>">
                    <div id="add_fieldsrole" class="panel-body">
                    </div>
                    <div class="panel-heading" style="border-radius: 0px">已分配权限</div>
                    <div id="add_fieldspermission" class="panel-body">
                    </div>
                </div>
            </div>
        </div>
