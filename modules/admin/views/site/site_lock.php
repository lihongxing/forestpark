...
<link href="/admin/css/lock.css" rel="stylesheet" type="text/css"/>
...
<div class="page-lock">
	<div class="page-logo">
		...
		<img src="/admin/image/logo-big.png" alt="logo"/>
		</a>
	</div>
	<div class="page-body">
		<img class="page-lock-img" src="/admin/image/profile.jpg" alt="">
...
<script src="/admin/js/jquery.backstretch.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<script src="/admin/js/app.js"></script>
<script src="/admin/js/lock.js"></script>
<script>
