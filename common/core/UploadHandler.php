...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => '上传文件超过upload_max_filesize php指令。iniThe超过upload_max_filesize指令在php . ini中上传文件',
        ...
        7 => '没有写文件到磁盘',
        8 => '一个PHP扩展停止了文件上传',
        'post_max_size' => '上传文件超过post_max_size指令在php . ini中',
        'max_file_size' => '文件太大了',
        'min_file_size' => '文件太小了',
        'accept_file_types' => '文件类型不允许',
        'max_number_of_files' => '超过了最大数量的文件',
        'max_width' => '图像超过最大宽度',
        'min_width' => '图像需要一个最小宽度',
        'max_height' => '图像超过最大高度',
        'min_height' => '图像需要一个最低高度',
        'abort' => '文件上传失败',
        'image_resize' => '未能调整图像'
    );
